...
The city of Porto has a *lot* of postal codes associated to it: https://worldpostalcode.com/portugal/porto/. As such, the whole record does not fit as an Aglolia index, so I had to limit the number of postal codes to 200, randomly chosen.
